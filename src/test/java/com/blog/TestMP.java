...
public class TestMP {
    private static String author = "XiaZhongzhen";//作者名称
    private static String outputDir = "D:\\";//生成的位置
    private static String driver = "com.mysql.cj.jdbc.Driver";//驱动
    //连接路径
    private static String url = "jdbc:mysql://localhost:3306/db_blog?useUnicode=true&characterEncoding=UTF-8&serverTime=UTC";
    private static String username = "root";//数据库用户名
    private static String password = "123456";//数据库密码
    private static String tablePrefix = "t_";//数据库表的前缀
